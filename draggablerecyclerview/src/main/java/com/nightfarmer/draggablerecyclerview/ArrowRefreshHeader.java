...
import com.nightfarmer.draggablerecyclerview.progressindicator.AVLoadingIndicatorView;
...
public class ArrowRefreshHeader extends LinearLayout implements BaseRefreshHeader {
    ...
    public void reset() {
        smoothScrollTo(0, new Animator.AnimatorListener() {
            @Override
    ...
    private void smoothScrollTo(int destHeight, Animator.AnimatorListener animatorListener) {
